...
Date.MONTH_NAMES = ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'];
...
function Chronoline(domElement, events, options) {
    ...
    t.init = function() {
        ...
        if(t.sections !== null){
            for(var i = 0; i < t.sections.length; i++){
                ...
                var elem = t.paper.rect(startX, 4, width, t.totalHeight);
    ...
    t.initScrollable = function(){
        ...
        t.leftControl.style.marginTop = t.topMargin/2 + 'px';
        ...
        t.rightControl.style.marginTop = t.topMargin/2 + 'px';
